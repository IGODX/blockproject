<?php $__env->startSection('content'); ?>
    <form action="<?php echo e(route('block.store')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="mb-3">
            <div class="form-group">
                <label class="form-label">Topic title: </label>
                <select name="topicid" class="form-control" class="<?php $__errorArgs = ['topicid'];
...
unset($__errorArgs, $__bag); ?>
                <a href="<?php echo e(route('topic.create')); ?>" class="mt-3 btn btn-outline-primary btn-sm">Add new topic</a>
            </div>
        </div>
        <div class="mb-3">
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-group mb-3">
            ...
            <input type="file" name="imagepath" class="form-control-file" id="uploadedFile"
                class="<?php $__errorArgs = ['imagepath'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\larablog\resources\views/block/create.blade.php ENDPATH**/ ?>